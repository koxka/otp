package hu.otp.ticketing.api.config;
...
import hu.otp.ticketing.api.security.RequestLoggingInterceptor;
...
public class GeneralConfig {
    ...
    public EventsApi eventsApi(@Value("${ticket.url}") String url,
                               ...
                               MappingJackson2HttpMessageConverter mappingJackson2HttpMessageConverter) {
        RestTemplate rt = getRestTemplate(user, pass, mappingJackson2HttpMessageConverter);
        hu.otp.ticketing.ticket.endpoint.rest.ApiClient apiClient = new hu.otp.ticketing.ticket.endpoint.rest.ApiClient(rt);
        apiClient.setBasePath(url);
